...
extern float xva1[6],yva1[6];
extern float xvb1[6],yvb1[6];
extern float xva2[6],yva2[6];
extern float xvb2[6],yvb2[6];
extern float xv1[4], yv1[4];
extern float xv2[4], yv2[4];
extern float xv3[4], yv3[4];
extern float xv4[4], yv4[4];
extern float out1, out2, old_out1, old_out2;
extern float out3, out4, old_out3, old_out4;
...
extern float mix1_selfreq[MAX_MIX1];
